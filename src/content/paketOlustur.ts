...
export const COPY = {
  ...
  step3: {
    ...
    optionalHint: "Telefon rezervasyon için gerekli. Not şimdi yazmasanız da olur.",
    phoneRequired: "Telefonunuzu yazın — rezervasyon için gerekli",
    phoneInvalid: "Telefon en az 10 haneli olmalı",
    summaryHeading: "Özet",
